...
If $E_n$ is a monotonically increasing sequence,
...
If $E_n$ is a monotonically decreasing sequence,

and there exists a set $A \in \mathfrak{A}$ with $\mu(A)<\infty$ such that $E_1\subset A,$
...
Let $(E_n : n \in \mathbb{N})$ be a monotonically increasing sequence in a $\sigma$ - algebra.
...
On the other hand, if decreasing,
