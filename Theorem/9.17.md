...
If there exists a $\mu$-integrable extended real-valued $\mathfrak{A}$-measurable function $g$ such that
$
f_n\geq g(f_n\leq g)
$ on $D$
for $n\in\mathbb{N}$, then there exists $\lim_{n\rightarrow \infty}f_n$ a.e. on $D$, $\lim_{n\rightarrow \infty}f_n$ is $\mu$-integrable on $D$ and 
